...
# // Make Config Link
vless_nontls="vless://${uuid}@cdn.who.int:${nontls_port}?path=cdn.who.int&security=none&encryption=none&host=${domain}&headerType=none&type=ws&quicSecurity=none#${Username}";
