...
# // Make Config Link
vless_nontls="vless://${uuid}@cdn.who.int:${nontls_port}?path=CF-RAY%3Ahttp%3A//cdn.who.int/vless&security=none&encryption=none&host=${domain}&headerType=none&type=ws&quicSecurity=none#${Username}";
