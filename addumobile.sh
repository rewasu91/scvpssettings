...
echo -e " ${vless_nontls2}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG UMOBILE ULIST" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls4}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_nontls4}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG UMOBILE UMGZ" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls5}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_nontls5}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
