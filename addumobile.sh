...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG UMOBILE MM" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo "" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls9}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo "" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_nontls8}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;