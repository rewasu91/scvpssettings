...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG UMOBILE WAP" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo "" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG UMOBILE PAY" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls3}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo "" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_nontls3}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo "" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG UMOBILE ROUTER" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls7}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo "" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_nontls7}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo "" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
