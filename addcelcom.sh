...
vless_tls="vless://${uuid}@104.20.65.29:${tls_port}?path=wss%3A//onlinepayment.celcom.com.my/vless&security=tls&encryption=none&host=${domain}&type=ws&sni=onlinepayment.celcom.com.my#${Username}";
