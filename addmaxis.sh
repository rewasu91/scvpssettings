...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS TV" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls4}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS SPEEDTEST" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls3}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS HUNT PORT 443" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
