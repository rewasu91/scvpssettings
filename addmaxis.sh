...
vless_tls="vless://${uuid}@italeem.iium.edu.my:${tls_port}?path=wss://italeem.iium.edu.my/vless&security=tls&encryption=none&host=${domain}&type=ws&sni=italeem.iium.edu.my#${Username}";
