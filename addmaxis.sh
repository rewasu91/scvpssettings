...
vless_tls6="vless://${uuid}@italeem.iium.edu.my.${domain}:${tls_port}?path=/vless&security=tls&encryption=none&host=italeem.iium.edu.my&type=ws&sni=www.italeem.iium.edu.my#${Username}";
...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS UNLIMITED NEW" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
