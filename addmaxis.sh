...
vless_tls4="vless://${uuid}@hq.viu.com.${domain}:${tls_port}?path=%2Fvless&security=tls&encryption=none&type=ws&sni=hq.viu.com#${Username}";
...
vless_tls6="vless://${uuid}@watch.viu.com.${domain}:${tls_port}?path=%2Fvless&security=tls&encryption=none&type=ws&sni=watch.viu.com#${Username}";
...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS TV HQ" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls4}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS TV WATCH" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls6}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS UNLIMITED HUNTIP" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
