...
vless_tls9="vless://${uuid}@adl-pccw.viu.com.${domain}:${tls_port}?path=/vless&security=tls&encryption=none&type=ws&sni=adl-pccw.viu.com#${Username}"
...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS TV WWW 443" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls8}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo "" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS TV WWW 80" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_nontls4}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS TV HELP VIU CF" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
